export const CustomQuery = (page, pageSize) => {
  return `SELECT r.OID as id, r.SequenceNumber, r.Type, r.Priority, r.HandlingResource,r.Zone,r.AgencyName,r.DispatchGroup,
