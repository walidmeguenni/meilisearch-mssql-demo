...
(async () => {
  ...
  const result =
    await request.query(`SELECT r.OID as id, r.SequenceNumber, r.Type, r.Priority, r.HandlingResource,r.Zone,r.AgencyName,r.DispatchGroup,
...
LEFT JOIN Comment co ON r.OID  = co.ResponseOID where OID = 2791502101276196961`);
